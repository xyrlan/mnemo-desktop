// adapted from stablyai/orca src/renderer/src/components/diff-comments/diff-comment-range-drag.ts (MIT, 122b8c25)
import * as monaco from 'monaco-editor'
import type { editor as monacoEditor } from 'monaco-editor'
import { getDragAutoScrollStepPx, REFERENCE_FRAME_MS } from './drag-auto-scroll'
import {
  areLineRangesEqual,
