// adapted from stablyai/orca src/renderer/src/components/diff-comments/diff-comment-add-button-overlay.ts (MIT, 122b8c25)
import * as monaco from 'monaco-editor'
import type { editor as monacoEditor } from 'monaco-editor'
import type { RefObject } from 'react'
import { getDiffCommentPopoverTop } from './popover-position'
import { toDiffCommentLineTarget } from './line-range'
import {
  getGutterPressLine,
