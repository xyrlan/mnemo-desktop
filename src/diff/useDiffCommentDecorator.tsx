// adapted from stablyai/orca src/renderer/src/components/diff-comments/useDiffCommentDecorator.tsx (MIT, 122b8c25)
import { useCallback, useEffect, useMemo, useRef } from 'react'
import type { editor as monacoEditor } from 'monaco-editor'
import { createRoot, type Root } from 'react-dom/client'
import { getCommentBodyLayoutLineCount } from './comment'
import {
  installDiffCommentAddButtonOverlay,
  type DiffCommentAddButtonOverlayHandle
} from './add-button-overlay'
import type { DiffCommentLineRange, DiffCommentLineTarget } from './line-range'
import { installDiffCommentZoneMouseDownStopper } from './zone-mouse-events'
import { getRenderSignature, renderDiffCommentZoneCard } from './zone-card'
...
type DecoratorArgs = {
  ...
  // Sends one note to the worktree's agent on its own; absent, the card has no send button.
...
export function useDiffCommentDecorator({
  ...
  }, [cancelScrollToZoneFrame, editor, filePath, monacoModelIdentity, worktreeId, comments])
